<?php
session_start();
  include "classes/viewnewcan.classes.php";
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr class="table-primary">
          ...
          <th scope="row"><?php echo $user['position']; ?></th>
          <th scope="row"><?php echo $user['matric']; ?></th>
          
          <td>
           <a href="classes/accept.classes.php?email=<?php echo htmlspecialchars($user['email']); ?>&user_id=<?php echo htmlspecialchars($user['user_id']); ?>">
