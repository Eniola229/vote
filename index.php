...
<html lang="en">
            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                        <li class="nav-item"><a class="nav-link me-lg-3" href="candidates.php">CANDATES</a></li>
                        <li class="nav-item"><a class="nav-link me-lg-3" href="vote.php">VOTE</a></li>
    ...
    <?php
        if (isset($_GET['status'])) {
            ...
            echo '<p style="color: red; text-align: center;">Kindly Click the Feed Back Button to give us your feed back!</p>';
        }
        ?>
        </p>
            <div class="container px-5">
        ...
        <section class="cta">
            <div class="cta-content">
                <div class="container px-5">
                    ...
                    <a class="btn btn-outline-light py-3 px-4 rounded-pill" href="candidates.php" target="_blank">Click Here</a>
                </div>
            </div>
        </section>
        <!-- App badge section-->
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body border-0 p-4">
                        ...
                        <form id="contactForm" action="include/feedback.inc.php" method="POST">
                            <!-- Name input-->
                            ...
                            <!-- Phone number input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="phone" type="text" name="candidates" required placeholder="There Name" data-sb-validations="required" />
                                <label for="phone">Candidate of your choice? Enter their name*</label>
                                <div class="invalid-feedback" data-sb-feedback="phone:required">This Field Is Required</div>
                            </div>
                            <!-- Message input-->
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="message" type="text" name="msg" required placeholder="Enter your message here..." style="height: 10rem" data-sb-validations="required"></textarea>
